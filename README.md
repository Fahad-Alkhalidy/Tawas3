...
1. **Landing** — choose Admin, Company, or Customer (stored in `localStorage` via Zustand persist).
...
4. **Customer** — browse approved companies, open profiles, mock contact.
...
| `/customer/browse` | Search/filter directory |
| `/customer/company/:id` | Public profile |
